...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bttnTransacoes = findViewById(R.id.bttnTransacoes);
        bttnTransacoes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, TransacaoActivity.class);
                startActivity(intent);
            }
        });


        //  APENAS PARA LIMPAR O BANCO DE DADOS, SE NECESSARIO
//        bttnTransacoes.setOnClickListener(v -> {
//            TransacaoHelper helper = new TransacaoHelper(this);
//            helper.limparTransacoes(); // Limpa todas as transações
//            atualizarTela();   // Atualiza a lista de transações (agora vazia)
//        });
